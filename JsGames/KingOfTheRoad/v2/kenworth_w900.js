...
export class KenworthW900 {
    constructor() {
        ...
        const width = 2.20;
        const length = 7.90;
        const height = 2.38 + 1.73;

        const chassisShape = new CANNON.Box(new CANNON.Vec3(width/2, 0.5, length/2));
    ...
    _addWheel(axle, side) {
        ...
        // this.wheelMeshes.push(CreateSimpleWheel(radius));
    }
    ...
    resetPosition(x, y, z) {
        this.vehicle.chassisBody.position.set(x, y, z, angle);
