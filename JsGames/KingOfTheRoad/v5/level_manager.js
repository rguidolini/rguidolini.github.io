export class LevelManager {
    ...
    setupLevel1() {
        this.ui.infoTitle.innerText = "Level 1: Simple Maneuver";
        this.ui.infoDescription.innerText = "Align and park the truck in the space.";
    ...
    setupLevel2() {
        this.ui.infoTitle.innerText = "Level 2: 90 Degree Maneuver";
        this.ui.infoDescription.innerText = "Align and park the truck in the space.";
    ...
    setupLevel3() {
        this.ui.infoTitle.innerText = "Level 3: Reverse parking";
        this.ui.infoDescription.innerText = "Align and reverse park the truck.";
    ...
    setupLevel4() {
        this.ui.infoTitle.innerText = "Level 4: Trailer Abilities";
        this.ui.infoDescription.innerText = "Hitch the trailer and park it on the indicated area";
    ...
    setupLevel5() {
        this.ui.infoTitle.innerText = "Level 5: Advanced Trailer Abilities";
        this.ui.infoDescription.innerText = "Hitch the trailer and reverse park it on the indicated area";
